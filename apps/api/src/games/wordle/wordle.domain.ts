...
import { WORDLE_WORD_LENGTH } from "../../common/constants";

export const WORDLE_ANSWERS: string[] = allWords.filter(
...
export function isValidWord(guess: string): boolean {
  return WORDLE_ANSWERS.includes(guess);
}
 ...
 * greens are fixed first, then remaining letters are matched for "present".
 */
...
/**
 * WON: 1000 - (attemptsUsed - 1) * 100. LOST/TIMEOUT always score 0.
 */
